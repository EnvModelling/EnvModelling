...
Students connect using SSH, edit model inputs or source files, run the
models from the command line, and retrieve model output for analysis.

Follow the instructions provided on the relevant course page and practical
sheet for each exercise.
